...
> **Utdatert på ett punkt:** rendering-formatet under er erstattet av ukeblokker — se [#1702](https://github.com/jdlarssen/golf-app/issues/1702) (kontrakten ligger som kommentar der). Resten av dokumentet står som det ble skrevet.
