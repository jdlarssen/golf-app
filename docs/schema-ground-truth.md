...
**Kilde: prod (`glofubopddkjhymcbaph`), målt 2026-08-30.** Staging matcher prod på alt under.

**Totaler:** 39 tabeller · 101 CHECK-constraints · 16 triggere · 47 SECURITY DEFINER-funksjoner.

### RLS og policy-antall per tabell (alle 39 har RLS på)
...
### SECURITY DEFINER-funksjoner (47)
