...
function entryInput(overrides: Partial<CupMatchEntryInput> = {}): CupMatchEntryInput {
  return {
    ...
    players: [
      { user_id: 'a1', team_number: 1, course_handicap: 0, users: { name: 'Per', nickname: null }, withdrawn_at: null },
    ...
    const { performance } = buildCupMatchEntry(
      entryInput({
        players: [
          ...
          { user_id: 'a2', team_number: 2, course_handicap: null, users: null, withdrawn_at: null },
        ],
        scores: [
