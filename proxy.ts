...
export const config = {
  ...
  matcher: [
    '/((?!_next/static|_next/image|api/|login|register|auth/callback|legal/|sw\\.js|manifest\\.webmanifest|icon|icon0|apple-icon|favicon\\.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)',
  ],
};
