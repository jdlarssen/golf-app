...
import { NassauSetup } from './NassauSetup';

// Én Type C render-test per docs/test-discipline.md — bekrefter at NassauSetup
...
// Detalj-poeng (unit-aggregering, push-på-tie) testes i scoring-laget,
// ikke her.

describe('NassauSetup', () => {
  it('rendrer scoring-toggle og kaller onScoringChange ved bytte', () => {
    const onScoringChange = vi.fn();

    render(
      <NassauSetup scoring="net" onScoringChange={onScoringChange} />,
    );
