            ...
            {rows.map((row, i) => (
              <div key={i} className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="w-16 rounded-lg border border-border px-2 py-2 bg-surface text-text text-sm tabular-nums focus:outline-none focus:ring-2 focus:ring-accent/40"
                />
                <input
                  type="number"
