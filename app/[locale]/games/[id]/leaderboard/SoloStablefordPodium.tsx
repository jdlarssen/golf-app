...
export function SoloStablefordPodium({
  ...
  // plassering vises som delt og ikke som sølv/bronse (#1372).
  ...
  const tiedBadge = (player: StablefordPlayerLine): string | null =>
    ...
    <LeaderboardShell chromeless={chromeless} footerSlot={footerSlot}>
      ...
      <div className="px-6 pt-1.5 pb-3.5 text-center">
        ...
        <p className="mt-1 text-[11.5px] tabular-nums text-muted">
          {t('soloStableford.podiumSubtitle', { holes: holesPlayed })}
        </p>
      </div>
...
function PodiumStep({
  ...
  // Akse-splitt (#1372): layout (høyde, testid, stagger) følger slotten;
  // presentasjon (farge, medaljong, poeng-styling) følger spillerens faktiske
